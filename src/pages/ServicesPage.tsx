    ...
    <>
      ...
      <section className="bg-gradient-to-r from-pink-100 to-blue-100 py-10 text-center my-12">
        ...
        <p className="mt-2 text-gray-700">
          <TranslatableText text="Work from start to finish usually takes about an hour to an hour and a
          half."/>
        </p>
        <p className="mt-2 text-gray-700">
          <TranslatableText text="Pricing may vary due to size, the condition of the coat, matting,
